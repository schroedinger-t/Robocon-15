...
//m1(Serial1,2);m2(Serial1,1);m3(Serial2,2),m4(Serial2,1)
  m1 = (V_x + V_y + 2*V_t)*12.7*2;  //Subtract |V_t| from absolute value of linear velocity
  m2 = (V_x - V_y - 2*V_t)*12.7*2;
  m4 = (-V_x - V_y + 2*V_t)*12.7*2; //Add |V_t| to absolute value of linear velocity
  m3 = (-V_x + V_y - 2*V_t)*12.7*2; 
